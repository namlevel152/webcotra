...
def hamburger(request):
    if request.user.is_authenticated:
        return render(request, "orders/hamburger.html", context = {"dishes":Hamburger.objects.all})
    else:
        return redirect("orders:login")

def potato(request):
    if request.user.is_authenticated:
        return render(request, "orders/potato.html", context = {"dishes":Potato.objects.all})
    else:
        return redirect("orders:login")

def chicken(request):
    if request.user.is_authenticated:
        return render(request, "orders/chicken.html", context = {"dishes":Chicken.objects.all})
    else:
        return redirect("orders:login")
...
def hotdog(request):
    if request.user.is_authenticated:
        return render(request, "orders/hotdog.html", context = {"dishes":Hotdog.objects.all})
    else:
        return redirect("orders:login")
...
def drinks(request):
    if request.user.is_authenticated:
        return render(request, "orders/drinks.html", context = {"dishes":Drinks.objects.all})
    else:
        return redirect("orders:login")
